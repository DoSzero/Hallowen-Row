...
import com.har.hallowenrow.OnSwipeListener
...
class MainActivity : AppCompatActivity() {
    ...
    private var itemsRes = intArrayOf(
        R.drawable.ic_hallowen1,
        R.drawable.ic_hallowen2,
        R.drawable.ic_hallowen7,
        R.drawable.ic_hallowen4,
        R.drawable.ic_hallowen5,
        R.drawable.ic_hallowen6,
    )
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        for (imageView in itemsVi) {
            imageView.setOnTouchListener(object : OnSwipeListener(this@MainActivity) {
